...
(function($) {
    ...
    $.fn.xMenu = function(options) {
        return $(this).each(function() {
            ...
            $mli.click(function() {
                var $li = $(this);
                var val = $li.parent().attr('data-cate') + '-' + $li.text();
                var id = $li.attr("rel");
                /*if ($selectinfo.is(":hidden")) {
                    $selectinfo.show();
                }*/
                $li.siblings().removeClass("current");
                $('.xmenu li').removeClass("current")
                if ($li.hasClass("current")) {
                    //$selectUl.find("li[rel='" + id + "']").remove();
                    $li.removeClass("current");
                } else {
                    $selectUl.html("<li rel='" + id + "' class='current'>" + val + "</li>");
                    $li.addClass("current");
                }
